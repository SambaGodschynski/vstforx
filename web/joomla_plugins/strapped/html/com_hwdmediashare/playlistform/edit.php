		...
		<div id="hwd-container"> <a name="top" id="top"></a> 
			...
			<div class="media-header">
				<div class="page-header">
					<?php if ($this->isNew):?>
					<h2><?php echo JText::_('COM_HWDMS_NEW_PLAYLIST'); ?></h2>
					<?php else: ?>
					<div class="btn-group pull-right"> <a rel="{handler: 'iframe', size: {x: 840, y: 500}}" class="btn modal" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=playlistmedia&tmpl=component&playlist_id=' . $this->item->id); ?>" title="<?php echo JText::_('COM_HWDMS_MANAGE_MEDIA'); ?>"> <i class="icon-cog"></i> <?php echo JText::_('COM_HWDMS_MANAGE_MEDIA'); ?></a> </div>
					<h2><?php echo JText::sprintf( 'COM_HWDMS_EDIT_PLAYLISTX', $this->escape($this->item->title)); ?></h2>
					<?php endif; ?>
				</div>
				<div class="clear"></div>
			</div>
			...
			<fieldset>
				...
				<div class="form-actions">
					<button type="button" class="btn" onclick="Joomla.submitbutton('playlistform.save')"> <?php echo JText::_('JSAVE') ?> </button>
					<button type="button" class="btn" onclick="Joomla.submitbutton('playlistform.cancel')"> <?php echo JText::_('JCANCEL') ?> </button>
				</div>
