...
\punkt{F} Das System soll VST2.x-Plugins zu laden können. Diese sollen beliebig miteinander verknüpfbar sein. Eine Verknüpfung entspricht dabei einer Ausgang/Eingang Verdrahtung wie sie bei reell existierenden Effektgeräten möglich sind. Ausgeschlossen hiervon sind jedoch Rückkopplungsschaltungen.
...
\punkt{F} Das System soll in der Lage sein, ein Effekt-Szenario und dessen Grafische Repräsentation, dauerhaft zu speichern und zu einem beliebigen Zeitpunk wiederherzustellen.

\punkt[1]{F} Das System soll in der Lage sein, den Speicher- und Ladevorgang Synchron mit der DAW auszuführen. So dass ein Effekt-Szenario mit einem DAW-Projekt gesichert und geladen wird.
...
\punkt[1]{F} Das System soll über zusätzliche Module verfügen die, wie Effekt-Plugins, das anliegende Audiosignal manipulieren können. Dazu gehören:
\begin{itemize}
