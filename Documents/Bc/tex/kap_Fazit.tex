...
\subsection{GUI}
Die VST-GUI Bibliothek bietet leider zu wenig oder unzureichend implementierte Funktionen, um eine vollwertige GUI-Anwendung zu entwickeln. So sind die meisten Elemente in VST-GUI, bitmapbasierend und mit festen Positionen versehen. Eine Schaltfläche muss daher erst gezeichnet und dann platziert werden. Eine dynamische Anwendung (Objekte veränderbarer in Größe und Position) mit einheitlichem Look-And-Feel, kann somit nur sehr schwer umgesetzt werden. 
\\\\
