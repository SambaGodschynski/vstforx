...
\\\\
So wäre eine Modultyp denkbar, der seine Berechnungszeit an ein externes Skript weitereichen würde. Besonders geeignet wäre hierfür die Skriptsprache \emph{Lua\footnote{http://www.lua.org/}}. Lua ist Kompiliert nur wenige Kilobyte groß und sehr leicht in ein bestehendes C/C++ - Programm einbindbar. 
