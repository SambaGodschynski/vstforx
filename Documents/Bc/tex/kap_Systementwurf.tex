...
\subsubsection{Die Graph-Klasse} Das Hauptelement in der Processing-Ebene ist der Graph. Die Graphklasse dient als Container, für alle auf der ''Bühne'' erzeugten Geschäftslogik-Objekte. Die Oberklasse dieser Objektklassen ist, die PObject-Klase\footnote{PObject = Processing Object}(siehe Abbildung \ref{graphoverview}).  

\subsubsection{Die G-Klasse}
...
\subsubsection{Die ProcessorNode-Klasse}
...
\subsubsection{\label{Optimierung}Optimierung} 
