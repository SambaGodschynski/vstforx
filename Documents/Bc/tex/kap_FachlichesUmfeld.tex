...
\\\\
Im VST2.x SDK ist dies eine Methode namens ''processReplacing''. Ihr werden als Parameter die Eingangs- und Ausgangssampleblöcke übergeben. Die Anzahl der Sampleblöcke ist abhängig von der Anzahl der Pluginein- sowie ausgangskanäle. So werden zum Beispiel einem Stereoplugin zwei Eingangssampleblöcke übergeben, jeweils ein Block für ''Rechts'' und ein Block für ''Links''. Das Plugin muss nun dafür sorgen dass, die Plugin-Audioausgabe in die entsprechenden Ausgangssampleblöcke geschrieben wird\verw{Vst}{Abschn.: 'AEffectX'}.
\\\\
