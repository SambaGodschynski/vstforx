...
Dies soll anhand des Sequenzers ''Cubase\footnote{Cubase SL 2.0 ( http://www.steinberg.net )}'' veranschaulicht werden:
\\\\
\begin{figure}[ht]
	\centering
...
Diese Regler könnte man verbinden um somit mehrere Regler mit einmal zu steuern. Somit ist wäre es zum Beispiel möglich die Intensität eines Halleffektes und die Intensität eines Verzerrers mit einem einzigen Regler gleichzeitig zu steuern.
Darüber hinaus bietet es sich an den Signalfluss und das verhalten der Effekte durch zusätzliche Module manipulierbar beziehungsweise erweiterbar zu machen. So wäre zum Beispiel eine Art ''Step-Sequencer'' denkbar. Ein Modul welches Rhythmisch zwischen verschiedenen Signalwegen umschaltet. 
\\\\
