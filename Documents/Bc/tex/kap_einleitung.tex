...
Je nach Typ wird das Audiosignal vor der Insert-Effektkette abgegriffen oder danach und in einen Effektkanal geleitet. Dieser Effektkanal besitzt ebenfalls eine begrenzte Anzahl von ''Insert-Slots''.
\\\\
...
Diese Regler könnte man verbinden und somit mehrere Regler gleichzeitig steuern. 
\\\\
So wäre es zum Beispiel möglich die Intensität eines Halleffektes und die Intensität eines Verzerrers mit einem einzigen Regler zu steuern.
...
\NP
\subsection{Der Name}
Als Programmname wurde ''VSTForx'' gewählt. 
