...
Dadurch lassen sich mehrere Parameter auf einmal Steuern. 
\ukap{Operatoren}
Zusätzlich können Sie, über das Kontextmenü einer Parameterverbindung, Operatoren auf solch eine Verbindung legen. Operatoren Verändern das Verhalten einer Parameter Verbindung. So wird zum Beispiel mit dem ''Inverse'' Operator bewirkt, das sich Verhalten des Nachbar-Parameters umkehrt. 
