<?php
/**
 * @version    SVN $Id: edit.php 882 2013-01-07 11:53:44Z dhorsfall $
 * @package    hwdMediaShare
 * @copyright  Copyright (C) 2011 Highwood Design Limited. All rights reserved.
 * @license    GNU General Public License http://www.gnu.org/copyleft/gpl.html
 * @author     Dave Horsfall
 * @since      26-Nov-2011 11:50:55
 */
		...
		<div id="hwd-container"> <a name="top" id="top"></a> 
			...
			<div class="media-header">
				<div class="page-header">
					<?php if ($this->isNew):?>
					<h2><?php echo JText::_('COM_HWDMS_NEW_GROUP'); ?></h2>
					<?php else: ?>
					<div class="btn-group pull-right"> <a rel="{handler: 'iframe', size: {x: 840, y: 500}}" class="btn modal" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupmedia&tmpl=component&group_id=' . $this->item->id); ?>" title="<?php echo JText::_('COM_HWDMS_MANAGE_MEDIA'); ?>"> <i class="icon-cog"></i> <?php echo JText::_('COM_HWDMS_MANAGE_MEDIA'); ?> </a> <a rel="{handler: 'iframe', size: {x: 840, y: 500}}" class="btn modal" href="<?php echo JRoute::_('index.php?option=com_hwdmediashare&view=groupmembers&tmpl=component&group_id=' . $this->item->id); ?>" title="<?php echo JText::_('COM_HWDMS_MANAGE_MEMBERS'); ?>"> <i class="icon-user"></i> <?php echo JText::_('COM_HWDMS_MANAGE_MEMBERS'); ?> </a> </div>
					<h2><?php echo JText::sprintf( 'COM_HWDMS_EDIT_GROUPX', $this->escape($this->item->title)); ?></h2>
					<?php endif; ?>
				</div>
				<div class="clear"></div>
			</div>
			...
			<fieldset>
				...
				<div class="form-actions">
					<button type="button" class="btn" onclick="Joomla.submitbutton('groupform.save')"> <?php echo JText::_('JSAVE') ?> </button>
					<button type="button" class="btn" onclick="Joomla.submitbutton('groupform.cancel')"> <?php echo JText::_('JCANCEL') ?> </button>
				</div>
