...
<plugin-repository name="testrep" author="samba godschynski" install-loc="testrep" 
  ...
  <vendor name="smartelectronix" url="www.smartelectronix.com" install-loc="smart_electronix">
    <plugin name="mda plugins" install-loc="mda">
      <file platform="windows" arch="i386" format="vst" filename="mda_vst_fx_win.zip">http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip</file>
      <file platform="mac" arch="i386, x64, ppc" format="vst" filename="mda_vst_ub.zip">http://mda.smartelectronix.com/vst/mda_vst_ub.zip</file>
    </plugin>
  </vendor>
</plugin-repository>
"""
...
class TestPlugBox(unittest.TestCase):
    ...
    def test_download(self):
        ...
        tc._load_to_download(platform="windows")
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip" in tc.to_download)
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_ub.zip" not in tc.to_download)
        tc.to_download={}
        
        tc._load_to_download(platform="windows, mac")
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip" in tc.to_download)
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_ub.zip" in tc.to_download)
        tc.to_download={}

        tc._load_to_download(platform="windows, mac", arch="x64")
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip" not in tc.to_download)
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_ub.zip" in tc.to_download)
        tc.to_download={}

        tc._load_to_download(platform="windows", arch="x64")
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip" not in tc.to_download)
        self.assertTrue("http://mda.smartelectronix.com/vst/mda_vst_ub.zip" not in tc.to_download)
        tc.to_download={}
    ...
    def test_add_remove(self):
        ...
        soll = """<plugin-repository author="samba godschynski" install-loc="testrep" name="testrep" tags="Windows, Mac, VST, i386, x64">\n  <vendor install-loc="smart_electronix" name="smartelectronix" url="www.smartelectronix.com">\n    <plugin install-loc="mda" name="mda plugins">\n      <file arch="i386" filename="mda_vst_fx_win.zip" format="vst" platform="windows">http://mda.smartelectronix.com/vst/mda_vst_fx_win.zip</file>\n      <file arch="i386, x64, ppc" filename="mda_vst_ub.zip" format="vst" platform="mac">http://mda.smartelectronix.com/vst/mda_vst_ub.zip</file>\n    </plugin>\n  </vendor>\n<vendor name="heimat"><plugin name="ppi"><file filename="TAL-Vocoder-2.zip" size="1033035">http://www.vstforx.de/tal.zip<binary md5="4a95d635143e50cc0466e140a6f05f02">TAL-Vocoder-2.dll</binary></file><file filename="Saro.dll" size="70656">http://www.vstforx.de/saro.dll<binary md5="ac69ed900c6c60df6591454d13e2fe58">Saro.dll</binary></file></plugin></vendor></plugin-repository>"""
